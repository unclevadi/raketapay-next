...
export function Hero() {
  return (
    <section
      id="hero"
      className="md:col-span-8 md:row-span-2 relative overflow-hidden bg-zinc-900 rounded-2xl sm:rounded-3xl bento-card group min-h-[min(85vh,660px)] flex items-end"
    >
      ...
      <div className="relative z-10 p-5 sm:p-8 w-full">
        <h1 className="font-header text-[clamp(1.9rem,4.6vw,4.35rem)] sm:text-[clamp(2.25rem,4vw,4.8rem)] md:text-[clamp(2.6rem,3.2vw,5rem)] leading-tight font-black uppercase italic mb-3 sm:mb-4 headline-outline">
          Оплачиваем всё.
          <br />
